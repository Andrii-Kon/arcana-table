        ...
        'input': [
            {
                ...
                'content': (
                    ...
                    'that generates a hand-drawn soulmate portrait, based on the quiz answers. Only soulmate portrait on the image, specify that, that sould be only one person on image (soulmate).'
